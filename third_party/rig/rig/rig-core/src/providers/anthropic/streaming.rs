...
use super::completion::{
    ...
    apply_cache_control, apply_tool_values_cache_control, split_system_messages_from_history,
};
...
impl GetTokenUsage for PartialUsage {
    fn token_usage(&self) -> Option<crate::completion::Usage> {
        ...
        usage.cached_input_tokens = self.cache_read_input_tokens.unwrap_or_default() as u64;
        usage.cache_creation_input_tokens =
            self.cache_creation_input_tokens.unwrap_or_default() as u64;
...
impl GetTokenUsage for StreamingCompletionResponse {
    fn token_usage(&self) -> Option<crate::completion::Usage> {
        ...
        usage.cached_input_tokens = self.usage.cache_read_input_tokens.unwrap_or_default() as u64;
        usage.cache_creation_input_tokens =
            self.usage.cache_creation_input_tokens.unwrap_or_default() as u64;
                                ...
                                match &event {
                                    StreamingEvent::MessageStart { message } => {
                                        ...
                                        cache_read_input_tokens = message
                                            ...
                                            .unwrap_or_default()
                                            .try_into()
                                            .expect("Failed to convert cache_read_input_tokens to usize");
                                        cache_creation_input_tokens = message
                                            .usage
                                            .cache_creation_input_tokens
                                            .unwrap_or_default()
                                            .try_into()
                                            .expect("Failed to convert cache_creation_input_tokens to usize");
...
mod tests {
    ...
    #[test]
    fn test_partial_usage_reports_cache_reads_and_writes() {
        let usage = PartialUsage {
            output_tokens: 40,
    ...
    #[test]
    fn test_streaming_completion_response_reports_cache_reads_and_writes() {
        ...
        let converted = response.token_usage().expect("usage conversion");
        assert_eq!(converted.input_tokens, 100);
        assert_eq!(converted.cached_input_tokens, 50);
        assert_eq!(converted.total_tokens, 190);
    }
