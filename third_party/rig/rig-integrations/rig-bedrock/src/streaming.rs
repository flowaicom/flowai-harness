...
impl CompletionModel {
    pub(crate) async fn stream(
        ...
        let request = AwsCompletionRequest::new(completion_request, self.prompt_caching);
...
mod tests {
    ...
    fn test_get_token_usage_trait() {
        let response = BedrockStreamingResponse {
            usage: Some(BedrockUsage {
                ...
                cache_write_input_tokens: Some(32),
            }),
        };
        ...
        assert_eq!(usage.cached_input_tokens, 160);
    }
    ...
    fn test_bedrock_usage_serde() {
        ...
        assert!(json.contains("\"cache_write_input_tokens\":5"));
    ...
    #[test]
    fn test_bedrock_streaming_cached_tokens_default_to_zero_when_absent() {
        let response = BedrockStreamingResponse {
            usage: Some(BedrockUsage {
                input_tokens: 120,
                output_tokens: 30,
